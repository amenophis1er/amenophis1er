...
- **[xPhone (Go version)](https://github.com/x-phone/xphone-go)** `Go` — The embedded telephony data plane for Go. Dial out, answer calls on any SIP trunk, or accept them as a SIP server — call audio arrives as PCM frames on a channel, ready for STT or a voice agent. Battle-tested across 500,000+ production calls.
