...
- **[cadence](https://github.com/amenophis1er/cadence)** `Go` — Provider-agnostic voice AI engines for Go — streaming STT, TTS and LLM behind uniform interfaces (Deepgram, ElevenLabs, Cartesia, Whisper, Anthropic, Gemini, OpenAI-compatible)
